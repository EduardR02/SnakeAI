...
grid_count = Point(20, 20)
food_gain_times = 1
window_size = grid_size * grid_count
label_font = "Courier 15 bold"
pause_between_frames_ms = 0
updates_per_draw = 1000
population_size = 10
mutation_rate = 0.075   # 0.1 seems to work best, can be randomly set to 0 - mutation_rate with random_mutate
